...
func (c *driverServiceClient) SetDriverRating(ctx context.Context, in *SetDriverRatingRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, "/proto.DriverService/SetDriverRating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDriverServiceServer) SetDriverRating(context.Context, *SetDriverRatingRequest) (*EmptyResponse, error) {
...
func _DriverService_SetDriverRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.DriverService/SetDriverRating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
